...
# tmux config
cp ~/.tmux.conf ./ & 
echo -e " Tmux \xE2\x9C\x94" & 

# Fonts
# cp -r ~/.fonts/ ./ & 
echo -e "Fonts \xE2\x9C\x94" & 
...
echo -e "Neofetch \xE2\x9C\x94" & 

# NeoVim config
cp -r ~/.config/nvim/ ./.config/ & 
echo -e "NeoVim \xE2\x9C\x94" & 
...
echo -e "Xfce4 Terminal \xE2\x9C\x94" & 

# Bash config
cp -r ~/.bashrc ./.config/ & 
echo -e "Bash config \xE2\x9C\x94" & 
